...
def CNN_model(X_train, learning_rate):
	...
	# Add a Convolutional layer with 4 filters, a 3x3 kernel, and ReLU activation function
	...
	# Add another Convolutional layer with 8 filters, a 3x3 kernel, and ReLU activation function
	...
	# Add a Fully Connected layer with 12 neurons and tanh activation function
	...
	# Create the Adamax optimizer with the specified learning rate
